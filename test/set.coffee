...
module.exports =
  ...
  'remove': (test) ->
    ...
    set.remove new vorrang.Set [4, 5]
  ...
  'properties that hold for any set': (test) ->
    ...
    xss.forEach (xs) ->
      ...
      set = new vorrang.Set xs

      # construction method 2
      set2 = new vorrang.Set
      set2.add xs

      set3 = new vorrang.Set
      ...
      test.ok set.isEqual new vorrang.Set set
